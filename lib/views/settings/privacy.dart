  ...
  final list = [
    ...
    _Category(title: "Data Security", list: [
      ...
      _Model(
        ...
        title: "Data Deletion",
        subTitle:
            "You can request the deletion of your personal information by contacting us at support@crucue.app. Please note that certain data may be retained for legal or operational purposes.",
      ),
      _Model(
        image: "user_rights.svg",
        title: "Opt-Out",
